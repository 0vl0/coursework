...
class UNet_no_skip(nn.Module):
    def __init__(self):
        ...
        self.transpose_conv1 = nn.ConvTranspose2d(in_channels=256, out_channels=256, kernel_size=2, stride=2)

        self.conv6 = Conv2(in_channels=256, out_channels=128)
        self.transpose_conv2 = nn.ConvTranspose2d(in_channels=128, out_channels=128, kernel_size=2, stride=2)

        self.conv7 = Conv2(in_channels=128, out_channels=64)
        self.transpose_conv3 = nn.ConvTranspose2d(in_channels=64, out_channels=64, kernel_size=2, stride=2)

        self.conv8 = Conv2(in_channels=64, out_channels=32)
        self.transpose_conv4 = nn.ConvTranspose2d(in_channels=32, out_channels=32, kernel_size=2, stride=2)
